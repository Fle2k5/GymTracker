...
VALUES (1,'legacy-disabled@gymtracker.invalid','Legacy data','!','USER',FALSE,CURRENT_TIMESTAMP);
ALTER TABLE app_users ALTER COLUMN id RESTART WITH 2;

ALTER TABLE exercises ADD COLUMN owner_id BIGINT DEFAULT 1 NOT NULL;
ALTER TABLE schedules ADD COLUMN owner_id BIGINT DEFAULT 1 NOT NULL;
ALTER TABLE schedule_exercises ADD COLUMN owner_id BIGINT DEFAULT 1 NOT NULL;
ALTER TABLE workout_history ADD COLUMN owner_id BIGINT DEFAULT 1 NOT NULL;
ALTER TABLE nutrition_entries ADD COLUMN owner_id BIGINT DEFAULT 1 NOT NULL;
ALTER TABLE milestones ADD COLUMN owner_id BIGINT DEFAULT 1 NOT NULL;
ALTER TABLE fitness_profiles ADD COLUMN owner_id BIGINT DEFAULT 1 NOT NULL;

ALTER TABLE exercises DROP CONSTRAINT uk_exercise_name;
ALTER TABLE exercises ADD CONSTRAINT uk_exercise_owner_name UNIQUE (owner_id,name);
ALTER TABLE schedule_exercises DROP CONSTRAINT uk_schedule_exercise;
ALTER TABLE schedule_exercises ADD CONSTRAINT uk_schedule_exercise UNIQUE (owner_id,schedule_id,exercise_id);
